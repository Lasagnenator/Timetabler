...
namespace Timetabler
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            DayNameTextView = FindViewById<TextView>(Resource.Id.DayNameTextView);
            WeekTextView = FindViewById<TextView>(Resource.Id.WeekTextView);
        ...
        public void UpdateAll(object sender, ElapsedEventArgs Args)
        {
            ...
            Day Today = Utils.GetCurrentDay(Database);
            if (Today != null)
            {
                Current = Utils.GetCurrentTimeSlot(Today.TimeSlots);
                Next = Utils.GetNextTimeSlot(Today.TimeSlots);
            ...
            int CurrentWeek = Utils.GetCurrentWeekNumber(Database);
            ...
            DayNameTextView.Text = TodayName;
            if (CurrentWeek != 0)
            {
                WeekTextView.Text = CurrentWeek.ToString();
            }
            else { WeekTextView.Text = "None"; }
